...
// @Component({
//   selector: 'app-annotators-from',
//   templateUrl: './annotators-from.component.html',
//   styleUrls: ['./annotators-from.component.css']
// })
// export class AnnotatorsFromComponent implements OnInit {
...
export class AnnotatorsFromComponent implements OnInit {
  ...
  readonly userRoles = [
    { val: 1, viewVal: 'ROLE_ANNOTATOR' },
    { val: 2, viewVal: 'ROLE_ADMIN' },
  ];
